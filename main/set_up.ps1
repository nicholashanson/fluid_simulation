...
function Compile-Code {
    ...
    # Build command
    $compileCommand = "g++ $gppArgs -o $outputFile " + ($files | ForEach-Object { $_ }) + " " + ($includes | ForEach-Object { "-I" + (Join-Path (Get-Location) $_) }) + " -IC:\tools\opencv\build\include" + " -I`"C:\Program Files (x86)\Intel\oneAPI\tbb\2022.0\include`"" + " -lfs_dpcxx -lopengl32 -lglfw3 -lgdi32 -ltbb12 -lopencv_world4110"
